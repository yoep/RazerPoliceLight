...
namespace RazerPoliceLightsBase.Effects
{
    public abstract class AbstractEffect : IEffect
    {
        ...
        protected AbstractEffect(INotification notification, ILogger logger, ISettingsManager settingsManager,
        ...
        public void Play(string vehicleName, EffectPattern effectPattern)
        {
            ...
            _effectThread = new Thread(() =>
            {
                ...
                catch (Exception ex)
                {
                    ...
                    _notification.DisplayPluginNotification("~r~plugin thread stopped responding");
                }
            }) {IsBackground = true};
            _effectThread.Start();
        }
        ...
        {
            var calculatedDelay =
                (int) (100 * SettingsManager.Settings.PlaybackSettings.SpeedModifier * patternRow.Speed);
        ...
        {
            Logger.Warn(
                "Effect thread is still running while starting a new effect playback, forcefully aborting thread");
            _effectThread.Abort();
        }
