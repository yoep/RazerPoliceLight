...
namespace RazerPoliceLightsBase.Devices.Corsair
{
    public class CorsairMouseEffect : AbstractMouseEffect
    {
        ...
        public CorsairMouseEffect(INotification notification, ILogger logger, ISettingsManager settingsManager, IColorManager colorManager)
        ...
        public override void Initialize()
        {
            ...
            if (_mouse != null)
            {
                _mouse.Brush = (SolidColorBrush) System.Drawing.Color.Transparent;
            ...
            else
            {
                ...
                Logger.Debug("Devices: " + string.Join(",",
                    CueSDK.InitializedDevices.Select(x => x.DeviceInfo.Type + "-" + x.DeviceInfo.Model)));
            }
        }
